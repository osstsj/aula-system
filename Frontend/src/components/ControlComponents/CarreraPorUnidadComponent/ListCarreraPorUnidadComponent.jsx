                ...
                <table className="table table-striped table-bordered"  style={{ boxShadow: '0 2px 8px 1px rgba(64, 60, 67, 0.24)' }}>
                        <thead>
                            <tr>
                                ...
                                <th className='table-title'>Nivel Academico</th>
                                ...
                                this.state.unidades.map((unidad, index)=>
                                    <tr key={unidad.id} >
                                        ...
                                        <td className='table-action'>
                                            <button onClick={()=> this.editCarreraPorUnidad(unidad.id)} className="btn btn-warning">Actualizar</button>
                                        ...
                                        > Eliminar</button> 
                                        <button onClick={()=> this.viewCarreraPorUnidad(unidad.id)} className="btn btn-info">Ver</button>
                                        </td>
                                    </tr>
                                )
                            }
